...
int main() {
  ...
  for (int iEvent = 0; iEvent < nEvent; ++iEvent) {
    ...
    cout << setw(5) << right << "jet #" << setw(10) << right << "rapidity" << setw(10) << right << "phi" << setw(15) << right << "pt (GeV)" << setw(22) << right << "jet area (Active)" << endl; 
    // Rd can't be obtained CluasterSequenceArea in case of active_area.
